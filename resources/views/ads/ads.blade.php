    ...
    <div class="card-panel light lighten-5 z-depth-1">
        ...
        <div class="card-body">
            @if($ads->count() > 0)
                @foreach($ads as $ad)
                    ...
                    <div class="list-item clearfix desrap" style="position: relative;">
                        ...
                        <div class="meta clearfix">
                            <a href="" title="Добавить в избранное"></a>
                            <a href="https://hoam.ru/category/construction_materials" class="meta-cat">{{$ad->cat_name}}</a>
                ...
                @endforeach
            @else
                <div class="center">Объявлений не найдено</div>
            @endif
