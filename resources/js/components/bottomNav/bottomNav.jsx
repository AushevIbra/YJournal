    ...
    if(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        return (
            <div className="bottom-navbar nav-color">
                ...
                {user !== null ?  <NavLink to="/notifications" ><i className="material-icons notif">notifications</i>
                    <small className="notification-badge">{notifications.length}</small></NavLink> : null}
